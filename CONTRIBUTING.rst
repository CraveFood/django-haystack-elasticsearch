...
Ready to contribute? Here's how to set up `haystack_elasticsearch` for local development.

1. Fork the `haystack_elasticsearch` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/haystack_elasticsearch.git
